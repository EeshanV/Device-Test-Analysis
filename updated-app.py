...
@st.cache_data
def get_filtered_data(df, selected_build_names, selected_test_names, selected_job_names, selected_arch_names):
    filtered_df = df
    if selected_build_names:
        filtered_df = filtered_df[filtered_df['build_name'].isin(selected_build_names)]
    if selected_test_names:
...
filtered_df = get_filtered_data(df, selected_build_names, selected_test_names, selected_job_names, selected_arch_names)
